...
class _TextSelectionToolbar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (handleMark != null) items.add(_buildToolbarButton('註記', handleMark));
...
class CupertinoMarkTextSelectionControls extends TextSelectionControls {
  CupertinoMarkTextSelectionControls({this.handleMark});
