...
typedef FlutterSelectionChangedHandler = void Function(TextSelection selection,
    FlutterRenderEditable renderObject, SelectionChangedCause cause);

typedef PaintContentHandler = void Function(
    FlutterRenderEditable renderObject, Canvas canvas);

///Copy from [RenderEditable]
class FlutterRenderEditable extends RenderBox {
  ...
  FlutterSelectionChangedHandler onSelectionChanged;
