...
class _TextSelectionToolbar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (handleMark != null)
      items.add(FlatButton(child: Text('註記'), onPressed: handleMark));

    if (handleCut != null)
      items.add(FlatButton(
          child: Text(localizations.cutButtonLabel), onPressed: handleCut));
    if (handleCopy != null)
      items.add(FlatButton(child: Text('複製'), onPressed: handleCopy));
//    if (handlePaste != null)
...
class MaterialMarkTextSelectionControls extends TextSelectionControls {
  MaterialMarkTextSelectionControls({this.handleMark});
  ...
  bool _isSelection(TextSelectionDelegate delegate) {
    return !_selection(delegate).isCollapsed ||  !_selection(delegate).isCollapsed; //目前不知道為什麼需要取兩次才會取到
  }
  ...
  Widget buildToolbar(BuildContext context, Rect globalEditableRegion,
    ...
    bool isSelection = _isSelection(delegate);
    return ConstrainedBox(
        ...
        child: CustomSingleChildLayout(
          ...
          child: _TextSelectionToolbar(
            handleCopy: isSelection ? () => handleCopy(delegate) : null,
            handleMark:
            isSelection ? () => handleMark(_selection(delegate)) : null,
          ),
        ));
  }
...
//final TextSelectionControls materialMarkTextSelectionControls =
//    _MaterialMarkTextSelectionControls();
