...
part 'flutter_text_selection.dart';
...
class FlutterTextEditingController extends TextEditingController {
  FlutterTextEditingController({String text})
      : _textSpan = null,
        super(text: text);

  FlutterTextEditingController.rich(this._textSpan)
...
class FlutterEditableText extends StatefulWidget {
  ...
  @override
  FlutterEditableTextState createState() => FlutterEditableTextState();
...
/// State for a [FlutterEditableTextState]. Copy from [EditableTextState]
class FlutterEditableTextState extends State<FlutterEditableText>
    with
        AutomaticKeepAliveClientMixin<FlutterEditableText>,
        WidgetsBindingObserver,
        TickerProviderStateMixin<FlutterEditableText>
  ...
  @override
  void didUpdateWidget(FlutterEditableText oldWidget) {
  ...
  void _handleSelectionChanged(TextSelection selection,
      FlutterRenderEditable renderObject, SelectionChangedCause cause) {
  ...
  FlutterRenderEditable get renderEditable =>
...
//    }
    ...
    if (widget.obscureText) {
      text = FlutterRenderEditable.obscuringCharacter * text.length;
      final int o =
...
class _FlutterEditable extends LeafRenderObjectWidget {
  const _FlutterEditable({
    Key key,
    this.textSpan,
    this.value,
    this.cursorColor,
  ...
  final FlutterSelectionChangedHandler onSelectionChanged;
  ...
  @override
  FlutterRenderEditable createRenderObject(BuildContext context) {
    return FlutterRenderEditable(
      text: textSpan,
  ...
  void updateRenderObject(
      BuildContext context, FlutterRenderEditable renderObject) {
    renderObject
      ..text = textSpan
      ..cursorColor = cursorColor
      ..showCursor = showCursor
